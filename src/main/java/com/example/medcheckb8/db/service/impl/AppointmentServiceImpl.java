...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AddAppointmentResponse save(AddAppointmentRequest request) {
        ...
        Department department = departmentRepository.findByName(Detachment.valueOf(request.department().toUpperCase()))
        ...
        context.setVariable("status", appointment.getStatus().getTranslate());
