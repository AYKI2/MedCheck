...
public interface ResultRepository extends JpaRepository<Result, Long> {
    @Query("select new com.example.medcheckb8.db.dto.response.ResultResponse(r.user.id, r.user.phoneNumber, r.user.account.email, r.dateOfIssue, r.department.name, r.file) " +
